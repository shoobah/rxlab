...
/***/ function(module, exports, __webpack_require__) {
	...
	var source$ = _rxDom.DOM.mousemove(el);
	
	var clicks$ = source$.filter(function (e) {
	    return e.buttons === 1;
	...
	var drawDot = function drawDot(x, y, color, el) {
	...
	var inside$ = clicks$.select(function (i) {
	    return i.X >= box.left && i.X <= box.left + box.width && i.Y >= box.top && i.Y <= box.top + box.height;
	});
	
	clicks$.withLatestFrom(inside$, function (c, i) {
	    return {
	        click: c,
	        inside: i
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function (factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2)], __WEBPACK_AMD_DEFINE_RESULT__ = function (Rx, exports) {
